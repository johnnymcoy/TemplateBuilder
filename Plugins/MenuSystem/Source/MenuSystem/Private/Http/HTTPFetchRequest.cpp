...
#include "Http/HTTPFetchRequest.h"
...
void UHTTPFetchRequest::HandleRequestCompleted(FString ResponseString, bool bSuccess)
{
	FString OutString;
	if (bSuccess)
	{
	...
	OnHttpRequestCompleted.Broadcast(OutString, bSuccess);
